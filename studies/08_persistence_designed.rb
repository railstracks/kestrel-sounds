...
# ============================================================
# The Persistence of Sound — DESIGNED VERSION (companion render)
# Variant of 08_persistence.rb by the Study-12-family gating fix.
#
# The ONLY functional difference from 08_persistence.rb:
#   beat = wall_beat          (this file — wall-clock-derived beats)
#   beat = cycle              (released version — loop iteration counter)
# Movements enter AND exit at their designed grid positions (beats
# 0/300/600/900/1200/1500/1800/2100 at 56 BPM → 2250s + ring-out).
# See gallivanting/music-studies/2026-08-24-persistence-forensics.md
# (Block 79): the released render is cumulative by bug, not by design.
# ============================================================
